...
My approach to SRE is founded on three concepts: **observability** (how do we know what's happening in a system), **automation** (how do we optimise a system by removing repetition), and **simplicity** (how do we design or refactor system to be simpler).
